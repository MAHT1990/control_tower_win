...
> 기획 입력: 사전 회의 3라운드 종합(`00_meeting_brief.md`)을 단일 입력 브리프로 도출.
...
| 04 | [`04_requirements`](./04_requirements.md) | 요구사항 FR/NFR·8카테고리·제약 | requirement_analyzer | **FR 45 · NFR 22** |
...
| 07 | [`07_interfaces`](./07_interfaces.md) | IA·화면 SC·흐름·UX | interface_designer | **SC 22** (FR 커버 45/45) |
...
- **식별자 총계**: FR 45 · NFR 22 · FN 55 · UT 5 · P 1 · BS 22 · JM 5 · SC 22 · ENT 18 · RISK 10 · 공통 카테고리 8(TRM·SES·PRF·IPC·OBS·AST·SEC·SYS)
- **MoSCoW(FR)**: Must 30 · Should 14 · Could 1
...
- **무결성**: FR 전수 커버리지 FN/SC/ENT/로드맵 **45/45** · 고아 참조 0 · 중복 ID 0
